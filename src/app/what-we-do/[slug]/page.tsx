  ...
  return (
    <div className="bg-white min-h-screen pb-24">
      ...
      <section className="bg-brand-charcoal text-white py-24 lg:py-32 relative overflow-hidden">
        <Image src="/images/headers/header-what-we-do.jpg" alt={program.title} fill className="object-cover z-0 opacity-20 mix-blend-luminosity" />
        ...
        <div className="container mx-auto px-4 relative z-10 flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2 h-80 lg:h-[400px] bg-brand-sage rounded-2xl flex items-center justify-center relative overflow-hidden border border-white/10 shadow-2xl">
            <span className="font-serif text-brand-green/30 text-2xl">Programme Hero Photo</span>
            <span className={`absolute top-6 right-6 z-20 text-[9px] uppercase font-bold tracking-widest px-3 py-1.5 rounded border backdrop-blur-sm shadow-sm ${
              program.status === "Active" ? "bg-white/90 text-brand-green border-white" : 
          ...
          <div className="lg:col-span-8 space-y-16">
              ...
              <div className="bg-[#fbf8f1] p-8 rounded-xl border border-brand-sage/50 space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Delivering weekly sessions and maintaining accountability via local volunteers.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[1,2,3].map((i) => (
                  <div key={i} className="aspect-square bg-brand-sage/40 rounded-xl flex items-center justify-center border border-gray-100 overflow-hidden relative group">
                    <span className="text-brand-green/30 text-[10px] font-bold uppercase tracking-widest">Image {i}</span>
