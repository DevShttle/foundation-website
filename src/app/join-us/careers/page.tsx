...
<<<<<<< HEAD
        <Image src="/images/headers/header-join-us.png" alt="Careers" fill className="object-cover z-0 opacity-30 mix-blend-luminosity" />
=======
        <Image src="/images/headers/header-join-us.jpg" alt="Careers" fill className="object-cover z-0 opacity-30 mix-blend-luminosity" />
