  ...
  const reports = [
    {
      ...
      icon: FileText,
      items: [
        { title: "Annual Activity Report 2024-2025", date: "April 2025", size: "2.4 MB" },
        { title: "Community Initiative Summary 2024", date: "December 2024", size: "1.1 MB" }
      ]
    },
    {
      ...
      icon: FileCheck2,
      items: [
        { title: "Registered Trust Deed (Redacted)", date: "July 2026", size: "4.5 MB" },
        { title: "Trustee Board Resolution (Extract)", date: "July 2026", size: "0.8 MB" }
      ]
    },
    {
      category: "Policies",
      icon: ShieldCheck,
      items: [
        { title: "Child Safeguarding Policy", date: "August 2026", size: "1.2 MB" },
        { title: "Anti-Discrimination & Inclusion Policy", date: "August 2026", size: "0.9 MB" },
        { title: "Financial Transparency Framework", date: "August 2026", size: "1.5 MB" }
      ]
    }
  ];
  ...
  return (
    <div className="bg-brand-ivory min-h-screen pb-24">
      ...
      <section className="bg-brand-charcoal text-white py-24 relative overflow-hidden">
        <Image src="/images/headers/header-news.jpg" alt="Reports" fill className="object-cover z-0 opacity-30 mix-blend-luminosity" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {section.items.map((item, i) => (
                  <div key={i} className="bg-white p-6 rounded-xl shadow-sm border border-brand-sage/50 flex items-start justify-between group hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                    ...
                    <button className="w-10 h-10 rounded-full bg-[#f2eee4] flex items-center justify-center text-brand-clay group-hover:bg-brand-clay group-hover:text-white transition-colors shrink-0">
                      <Download size={18} />
                    </button>
                  </div>
                ))}
