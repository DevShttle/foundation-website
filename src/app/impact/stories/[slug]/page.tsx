  ...
  return (
    <div className="bg-white min-h-screen pb-24">
      ...
      <section className="bg-brand-sage h-[400px] lg:h-[500px] relative flex items-center justify-center overflow-hidden">
        <Image src={story.image || `/images/stories/story-1.png`} alt={story.title} fill className="object-cover z-0" />
      </section>
      ...
      <div className="container mx-auto px-4 -mt-32 relative z-20 max-w-4xl">
        <div className="bg-white p-8 lg:p-16 rounded-xl shadow-xl border border-gray-100">
          ...
          <div className="prose prose-lg prose-emerald text-brand-charcoal/80 max-w-none">
            ...
            <p>
              {story.context || "In many underserved areas, access to continuous guidance is limited. This section outlines the specific background of the individual or community featured in this story, detailing the challenges they faced before connecting with Islah Foundation."}
            </p>

            <h3 className="font-serif text-2xl text-brand-green mt-12 mb-4">The Intervention</h3>
            <p>
              {story.intervention || "Through our localized approach, we provided targeted support. This might include weekly mentoring, learning kits, or digital skills workshops, delivered collaboratively with community volunteers."}
            </p>
            ...
            <div className="my-12 bg-[#f2eee4] p-8 rounded-lg border border-brand-sage/50">
               ...
               <p className="text-sm">
                 {story.outcome || "Measurable progress was observed over several months. Confidence increased, participation in school improved, and the foundational steps toward long-term educational resilience were established."}
               </p>
            </div>
          </div>
