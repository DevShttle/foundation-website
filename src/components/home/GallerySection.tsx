        ...
        {filteredImages.length > 8 && (
          <div className="mt-12 text-center">
            <button 
              ...
              className="bg-brand-green text-white px-8 py-3 rounded text-xs font-bold uppercase tracking-widest hover:bg-[#083F33] transition-colors inline-flex items-center gap-2 shadow-md hover:shadow-lg"
            >
              {showAll ? "Show Less" : `View All Photos (${filteredImages.length})`}
            </button>
          </div>
        )}
      </div>
      ...
      {selectedImageIndex !== null && filteredImages[selectedImageIndex] && (
        ...
        >
          ...
          <button 
            ...
            className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 text-white/80 hover:text-white bg-white/10 hover:bg-white/20 p-3 rounded-full transition-colors z-50"
          ...
          >
            ...
            <div className="mt-4 text-center text-white">
              <span className="text-[10px] uppercase tracking-widest font-bold text-brand-gold bg-brand-green/90 px-3 py-1 rounded-full mb-2 inline-block">
          ...
          <button 
            ...
            className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 text-white/80 hover:text-white bg-white/10 hover:bg-white/20 p-3 rounded-full transition-colors z-50"
